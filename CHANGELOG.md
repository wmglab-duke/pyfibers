...
- Add link checking to docs build process
  ([`ecde876`](https://github.com/wmglab-duke/pyfibers/commit/ecde87667928ab9281bca78bad174f45fed20153))
...
- Add linkcheck exception for github docs
  ([`f9e0c44`](https://github.com/wmglab-duke/pyfibers/commit/f9e0c443ed3e632fd0137c31ca58bb5f86c379fd))

- Add linkcheck exception for github docs
  ([`84f4c89`](https://github.com/wmglab-duke/pyfibers/commit/84f4c898ee6b96c807f988025f4e03facb7323c1))

- Fix github docs ci for linkcheck
  ([`ecde876`](https://github.com/wmglab-duke/pyfibers/commit/ecde87667928ab9281bca78bad174f45fed20153))

- Fix issue with docs building using new linkcheck on github
  ([`8f01f54`](https://github.com/wmglab-duke/pyfibers/commit/8f01f5474b798ba7dcb44efeaedbe03d6e8b431b))

- Ignore link that is broken for checklinks
  ([`c5df37c`](https://github.com/wmglab-duke/pyfibers/commit/c5df37cba88eead9c85d979d74101ec3a172ce6e))
...
- Add double backticks to code references
  ([`5a85345`](https://github.com/wmglab-duke/pyfibers/commit/5a85345324f05cc1ddb18fe6bacefa30fd74aa91))

- Add favicon to docs
  ([`8e5a0fa`](https://github.com/wmglab-duke/pyfibers/commit/8e5a0faef5b30392615a6ddc5c818da0f21402fc))

- Add new publications using PyFibers to docs
  ([`2dcb252`](https://github.com/wmglab-duke/pyfibers/commit/2dcb2524908be75db47bb7513d1d3491e92c61c8))

- Fix broken cross references and add new NEURON class references
  ([`c4410b6`](https://github.com/wmglab-duke/pyfibers/commit/c4410b6a7460ce1fc1d5954b6b234c041fb404d2))

- Fix xrefs and add units where needed
  ([`c4410b6`](https://github.com/wmglab-duke/pyfibers/commit/c4410b6a7460ce1fc1d5954b6b234c041fb404d2))

- Possible fix for enum docs not rendering on github docs
  ([`4da69ba`](https://github.com/wmglab-duke/pyfibers/commit/4da69baa376407b73c0e97957d450fe1ca038207))

- Update custom fiber docs for class attributes
  ([`09f93f5`](https://github.com/wmglab-duke/pyfibers/commit/09f93f580010cb2836c8130a014d2bf3b51a2467))

- Update docs to describe units where needed
  ([`5c5db16`](https://github.com/wmglab-duke/pyfibers/commit/5c5db16d01ab9c88054fc5a1748acc12d5bdb5b5))

- Update fiber models descriptions
  ([`a452cdf`](https://github.com/wmglab-duke/pyfibers/commit/a452cdf4dfe21c98149aac5ed4bc1855906dff5d))

- Update parallelism tutorial to not use deprecated "silent" parameter
  ([`0da2491`](https://github.com/wmglab-duke/pyfibers/commit/0da2491f5bf2b242cbc206173d6d5eb12a18baf7))

- Update parameter documentation to remove bullets that rendered improperly
  ([`3908729`](https://github.com/wmglab-duke/pyfibers/commit/39087290beef71f5186325d81defce87ef395d4c))

- Updates to documentation for clarity and readability
  ([`06659b4`](https://github.com/wmglab-duke/pyfibers/commit/06659b4696dc61512877d6d71f0e3b5f2b9c36bc))
...
- Fix syntax for neuron reference
  ([`39b7d00`](https://github.com/wmglab-duke/pyfibers/commit/39b7d00e5fdec0199e204435496dc31fff3de67c))
...
- Add gating variable to thio model data logging
  ([`a7472f8`](https://github.com/wmglab-duke/pyfibers/commit/a7472f84068f73483509fa4583ebadbd5cdc9e5c))
...
- Disable config keeping major version at 0
  ([`c5610e5`](https://github.com/wmglab-duke/pyfibers/commit/c5610e5fadc4a0f0684d2d1369c4e76c07d1c712))
...
- Fix bug where stimulation __str__ did not print class tstop correctly
  ([`34dc461`](https://github.com/wmglab-duke/pyfibers/commit/34dc461ed033d1a45b8bf76171d0e1dfbc9b8a7e))
...
- Update build pipeline to use semantic release publishing
  ([`d00b32a`](https://github.com/wmglab-duke/pyfibers/commit/d00b32af85ea40d57ab929ebb871b7ef762bf4fc))
...
- Fix bug where repeated creation of fiber using the same varname could cause fiber.time to stop
  recording
  ([`119ac12`](https://github.com/wmglab-duke/pyfibers/commit/119ac1253305fd07d87ea9097db9ba51c853fe57))
...
- **IntraStim**: Add cleanup routine so that IntraStim does not leave vestigial trainIClamp on
  fibers
  ([`f43d7ec`](https://github.com/wmglab-duke/pyfibers/commit/f43d7eceab1dae985f01ca9f55b5007b97c6d369))
...
- Add feature details to README
  ([`6cec1ae`](https://github.com/wmglab-duke/pyfibers/commit/6cec1ae0283e91662e54d23713481773af4f3a0e))
...
- Add force push to github push
  ([`e11cf79`](https://github.com/wmglab-duke/pyfibers/commit/e11cf79f721361db93e8a0d2b68abae07b7bb190))

- Added file to skip github jekyll
  ([`ed3b67f`](https://github.com/wmglab-duke/pyfibers/commit/ed3b67f2a36bfcf8b024bb3635ea4a372822d5ec))

- Change push target to correct link
  ([`3970931`](https://github.com/wmglab-duke/pyfibers/commit/3970931b17f51d547635aafb167a7fce176ee53d))

- Drop twine upload from gitlab-ci
  ([`a7d7a25`](https://github.com/wmglab-duke/pyfibers/commit/a7d7a25b69de03079ea80aa941adbb5c61a57aca))
...
- Releases should now function properly
  ([`4d3ab8a`](https://github.com/wmglab-duke/pyfibers/commit/4d3ab8a1feda2352a5429275f45cc76175507a3c))

### Documentation

- Elie review pass on documentation
  ([`361b863`](https://github.com/wmglab-duke/pyfibers/commit/361b86382ac3e19f7057fc22c321716213e54751))

- Update latex engine and add proper version acquisition for docs
  ([`2fdab8f`](https://github.com/wmglab-duke/pyfibers/commit/2fdab8f24d887a868bd638a6f7ee04aa2f6db9c5))
...
- Added commitizen to pre-commit
  ([`fdd34cd`](https://github.com/wmglab-duke/pyfibers/commit/fdd34cdbe0d875bc029361706d8f5a31b59d2acd))
